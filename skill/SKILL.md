...
description: "A PMP-certified program management advisor and toolkit built from Brandon Uttley's 20+ year career across enterprise transformations, agency leadership, and startup growth. Use this skill whenever someone is planning a complex initiative, launching a program, coordinating cross-functional stakeholders, taking over a stalled project, running marketing program management, evaluating vendors, or producing the artifacts a senior PM ships (charters, RAID logs, status reports, scope memos, campaign briefs, RFP scorecards, etc.). Also trigger for program planning, stakeholder alignment, cross-functional coordination, risk assessment, content operations, regulatory review workflows, capacity planning, and any variation of 'how do I get this done' or 'this project is a mess.' Do not wait for the user to ask for project management specifically — trigger when they're wrestling with a multi-stakeholder effort, and produce real artifacts when the moment calls for one."
---
